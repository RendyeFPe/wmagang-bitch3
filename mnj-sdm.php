...
<body style="background: #e6eaf2;">
    ...
    <div class="container-bg">
        <div class="container-title">
            ...
            <div class="title">
                <h1>Penataan Manajemen Sumber Daya Manusia</h1>
            </div>
        </div>
        <div class="text">
            <p>Untuk membangun unit pelayanan yang berintegritas dan mampu memberikan kualitas pelayanan prima, diperlukan adanya <span>manajemen SDM</span> disesuaikan dengan kebutuhan unit pelayanan dalam menghasilkan pelayanan yang berkualitas.</p>
        </div>
        ...
        <div class="text-pv">
            <p>Meningkatnya profesionalisme pada zona integritas menuju WBK/WBBM.</p>
        </div>
        ...
        <div class="text-pt">
            <ol>
                <li>Meningkatnya ketaatan terhadap pengelolaan SDM aparatur</span></li>
                <li>Meningkatnya transparasi dan akuntabilitas pengelolaan SDM aparatur</li>
                <li>Meningkatnya disiplin aparatur</li>
                <li>Meningkatnya efektivitas manajemen SDM aparatur</li>
                <li>Meningkatnya profesionalisme SDM</li>
            </ol>
        </div>
        ...
        <div class="box-content">
            <div>
                ...
                <div class="text-box1">
                    <ol>
                        <li>Perencanaan kebutuhan pegawai sesuai dengan kebutuhan organisasi</li>
                        <li>Pola mutasi internal</li>
                        <li>Pengembangan pegawai berbasis kompetensi</li>
                        <li>Penetapan kinerja individu</li>
                        <li>Penetapan aturan disiplin/kode etik</li>
                        <li>Sistem informasi kepegawaian</li>
                    </ol>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="text-box2">
                    <ol>
                        <li>Kinerja individu</li>
                        <li>Assessment kepegawaian</li>

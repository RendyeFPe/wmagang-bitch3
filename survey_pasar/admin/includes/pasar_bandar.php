...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><a id='validasi-button' href='../admin/includes/pasar_bandar.php?action=validasi&id=" . $row['id_barang'] . "'>Validasi</a> | <a id='edit-button' href='?action=edit&id=" . $row['id_barang'] . "&source=edit_bandar'>Edit</a></td>";
        echo "</tr>";
    }
    echo "</table>";
    echo "</div>";

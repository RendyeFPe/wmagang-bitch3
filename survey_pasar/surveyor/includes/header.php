...
if (isset($_SESSION['user_role'])) {
  ...
  if ($_SESSION['user_role'] !== 'surveyorBandar' && $_SESSION['user_role'] !== 'surveyorPahing' && $_SESSION['user_role'] !== 'surveyorSetonobetek') {
    header("location: ../index.php");
    exit(); // Tambahkan exit setelah header untuk menghentikan eksekusi skrip lebih lanjut
  }
} else {
  header("Location: ../index.php");
}
...
<head>
  ...
  <style>
    .navbar {
      /* background: #f0b736; */
      background: linear-gradient(180deg, #076797 0%, #12946D 100%);
    }

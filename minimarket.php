        ...
        <div class="container">
            ...
            <div class="row d-flex">
                <div class="col text-center">
                    <div class="drop">
                        <ul class="main-menu">
                            <li><a href="#" class="dropbtn border-2 border-black border dropdown-toggle border-dark" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Minimarket</a>
                                <ul class="sub-menu custom-tbl">
                                    <li>
                                        <a href="#" class="dropdown-item custom-tbl" onclick="show('indomaret')">Indomaret</a>
                                        <!-- <ul class="sub-menu custom-tbl">
                                    ...
                                    <li>
                                        <a href="#" class="dropdown-item custom-tbl" onclick="show('alfamart')">Alfamart</a>
                                        <!-- <ul class="sub-menu custom-tbl">
                    ...
                    <div class="drop">
                        <ul class="main-menu">
                            <li>
                                <a href="#" class=" dropbtn border-2 border-black border border-dark" aria-haspopup="true" aria-expanded="false" onclick="show('supermarket')">Supermarket</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div id="indomaret">
                ...
                <div class="container mt-4">
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 g-2 g-lg-3 d-flex justify-content-center">
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                                    <img src="images/minimarket/indomaret/Indomaret Agus Salim.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Agus Salim</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                                    <img src="images/minimarket/indomaret/Indomaret Kemuning.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Kemuning</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop3">
                                    <img src="images/minimarket/indomaret/Indomaret Raung.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Raung</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop4">
                                    <img src="images/minimarket/indomaret/indomaret Semeru.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Semeru</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop5">
                                    <img src="images/minimarket/indomaret/indomaret veteran.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Veteran</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop6">
                                    <img src="images/minimarket/indomaret/Indomaret Wakhid Hasyim.jpeg" class="img-thumbnail">
                                    <div class="card-body px-0">
                                        <p class="card-text text-center">Indomaret Wachid Hasyim</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop7">
                                    <img src="images/minimarket/indomaret/indomaret penanggungan.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Penanggungan</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop8">
                                    <img src="images/minimarket/indomaret/Indomaret Mojoroto.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Mojoroto</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop9">
                                    <img src="images/minimarket/indomaret/Indomaret Ahmad Dahlan.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Ahmad Dahlan</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop10">
                                    <img src="images/minimarket/indomaret/indomaret gatot subroto.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Gatot Subroto</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop11">
                                    <img src="images/minimarket/indomaret/Indomaret Sersan Bahrun.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Sersan Bahrun</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div class="container mt-4">
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 g-2 g-lg-3 d-flex justify-content-center">
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop12">
                                    <img src="images/minimarket/indomaret/Indomaret Kilisuci.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Kilisuci</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop13">
                                    <img src="images/minimarket/indomaret/Indomaret Mauni Kediri.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Mauni Kediri</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop13">
                                    <img src="images/minimarket/indomaret/indomaret pesantren.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Pesantren</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop15">
                                    <img src="images/minimarket/indomaret/Indomaret Letjend Sutoyo Kediri.jpeg" class="img-thumbnail">
                                    <div class="card-body mb-1">
                                        <p class="card-text text-center" style="font-size:91%;">Indomaret Letjend Sutoyo Kediri</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop16">
                                    <img src="images/minimarket/indomaret/Indomaret Ngronggo.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Ngronggo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop17">
                                    <img src="images/minimarket/indomaret/Indomaret Doko Indah.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Doko Indah</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop18">
                                    <img src="images/minimarket/indomaret/Indomaret Selowareh.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Indomaret Selowareh</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop19">
                                    <img src="images/minimarket/indomaret/Indomaret Joyoboyo.jpeg" class="img-thumbnail">
                                    <div class="card-body mb-1">
                                        <p class="card-text text-center">Indomaret Joyoboyo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop20">
                                    <img src="images/minimarket/indomaret/Indomaret Sersan Suharmaji.jpeg" class="img-thumbnail">
                                    <div class="card-body px-0">
                                        <p class="card-text text-center">Indomaret Sersan Suharmaji</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <!--15. Indomaret Letjend Sutoyo Kediri-->
                        ...
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop21">
                                    <img src="images/minimarket/alfamart/Alfamart Semeru Kediri.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Semeru</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop22">
                                    <img src="images/minimarket/alfamart/alfamart kawi.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Kawi</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop23">
                                    <img src="images/minimarket/alfamart/Alfamart Mojoroto.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Mojoroto</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop24">
                                    <img src="images/minimarket/alfamart/Alfamart Agus Salim.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Agus Salim</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop25">
                                    <img src="images/minimarket/alfamart/Alfamart Mastrip Kediri.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Jl. Mastrip</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop26">
                                    <img src="images/minimarket/alfamart/Alfamart Dr. Sahardjo.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Dr. Sahardjo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop27">
                                    <img src="images/minimarket/alfamart/Alfamart Mrican.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Mrican</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop28">
                                    <img src="images/minimarket/alfamart/Alfamart Mauni Kediri.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Mauni</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop29">
                                    <img src="images/minimarket/alfamart/Alfamart Imam Bakri.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Imam Bakri</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop30">
                                    <img src="images/minimarket/alfamart/Alfamart Kapten Piere Tendean.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Kapten Tendean</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images/minimarket/alfamart/Alfamart Letjend Sutoyo.jpeg" class="img-thumbnail">
                                    <div class="card-body px-0">
                                        <p class="card-text text-center">Alfamart Letjend Sutoyo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop32">
                                    <img src="images/minimarket/alfamart/Alfamart Letjend Suprapto.jpeg" class="img-thumbnail">
                                    <div class="card-body px-0">
                                        <p class="card-text text-center">Alfamart Letjend Suprapto</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop33">
                                    <img src="images/minimarket/alfamart/Alfamart Urip Sumoharjo.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Urip Sumoharjo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop34">
                                    <img src="images/minimarket/alfamart/Alfamart Super Semar.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Super Semar</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop35">
                                    <img src="images/minimarket/alfamart/Alfamart Betet Bawang.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Betet Bawang</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop36">
                                    <img src="images/minimarket/alfamart/Alfamart Ngronggo.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Ngronggo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop37">
                                    <img src="images/minimarket/alfamart/Alfamart Kilisuci.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Kilisuci</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop38">
                                    <img src="images/minimarket/alfamart/Alfamart Mayjend Sungkono.jpeg" class="img-thumbnail">
                                    <div class="card-body px-0">
                                        <p class="card-text text-center">Alfamart Mayjend Sungkono</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" >
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop39">
                                    <img src="images/minimarket/alfamart/Alfamart Patiunus.jpeg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Alfamart Patiunus</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div class="container mt-4">
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 g-2 g-lg-4 d-flex justify-content-center">
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images/minimarket/supermarket/transmart.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Transmart</p> 
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images/minimarket/supermarket/samudra.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Samudra Swalayan</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images/minimarket/supermarket/hypermart.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Hypermart</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images/supermarket/golden-.jpg" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Golden Swalayan</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images=/supermarket/" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">Super Indo Hasanudin</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#staticBackdrop31">
                                    <img src="images=/supermarket/" class="img-thumbnail">
                                    <div class="card-body">
                                        <p class="card-text text-center">SuperIndo</p>
                                    </div>
                                </a>
                            </div>
                        </div>
            ...
            <!-- MekarMart -->
            <div id="alfamidi">
                <h5 class="text-center my-5">Mekar Mart Kota Kediri</h5>
                <div class="container mt-4">
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 g-2 g-lg-4 d-flex justify-content-center">
                        <div class="col">
                            <div class="card">

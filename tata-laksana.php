...
<body style="background: #e6eaf2;">
    ...
    <div class="container-bg">
        ...
        <div class="text">
            <p>Untuk membangun unit pelayanan yang berintegritas dan mampu memberikan kualitas layanan yang prima, diperlukan adanya <span>penataan tata laksana yang mendorong efisiensi</span> dan mempercepat proses pelaksanaan tugas dan fungsi unit pelayanan.</p>
        </div>
        ...
        <div class="text-pv">
            <p>Meningkatkan efisiensi dan efektivitas sistem, proses, dan prosedur kerja yang <span style="font-weight: 700;">jelas, efektif, efisien</span> dan <span style="font-weight: 700;">terukur</span> pada zona integritas menuju WBK/WBBM.</p>
        </div>
        ...
        <div class="text-pt">
            <ol>
                <li>Meningkatkan penggunaan teknologi informasi dalam proses penyelenggaraan manajemen pemerintahan</li>
                <li>Meningkatnya efisiensi dan efektivitas manajemen pemerintahan</li>
                <li>Meningkatnya kinerja unit kerja atau satuan kerja</li>
            </ol>
        </div>
        ...
        <div class="box-content">
            ...
            <div>
                ...
                <div class="text-box2">
                    <ol>
                        <li>Peta probis mempengaruhi</li>
                        <li>SPBE</li>
                        <li>Transformasi digital memberikan nilai manfaat</li>
                    </ol>
                </div>
            </div>
        </div>

    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="no_registrasi" name="no_registrasi" value="<?php echo $data['no_registrasi']; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_kelurahan" name="nama_kelurahan" value="<?php echo $data['nama_kelurahan']; ?>" >
            </div>
            <div class="mb-3">
                <label for="alamat_ktp">Alamat KTP</label>
                <input type="text" class="form-control" id="alamat_ktp" name="alamat_ktp" value="<?php echo $data['alamat_ktp']; ?>" >
            </div>
            <div class="mb-3">
                <label for="alamat_usaha">Alamat Usaha</label>
                <input type="text" class="form-control" id="alamat_usaha" name="alamat_usaha" value="<?php echo $data['alamat_usaha']; ?>" >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="jenis_jualan" name="jenis_jualan" value="<?php echo $data['jenis_jualan']; ?>" >
            </div>
            <div class="mb-3">
                <label for="jam_operasional">Jam Operasional</label>
                <input type="text" class="form-control" id="jam_operasional" name="jam_operasional" value="<?php echo $data['jam_operasional']; ?>" >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $data['latitude']; ?>" >
            </div>
            <div class="mb-3">
                <label for="longitude">Longitude</label>
                <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $data['longitude']; ?>" >
            </div>
            <!-- Tombol -->

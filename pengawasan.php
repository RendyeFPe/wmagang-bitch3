...
<body style="background: #e6eaf2;">
    ...
    <div class="container-bg">
        ...
        <div class="text">
            <p>Untuk membangun unit pelayanan yang berintegritas dan mampu memberikan kualitas pelayanan prima, diperlukan adanya sistem pengendalian internal untuk memastikan integritas pelayanan.</p>
        </div>
        ...
        <div class="text-pv">
            <p>Meningkatkan penyelenggaraan pemerintahan yang bersih dan bebas KKN pada masing-masing instansi.</p>
        </div>
        ...
        <div class="text-pt">
            <ol>
                <li>Meningkatnya kepatuhan terhadap pengelolaan keuangan negara oleh masing-masing instansi pemerintah</li>
                <li>Menurunnya tingkat penyalahgunaan wewenang pada unit kerja</li>
                <li>Meningkatnya sistem integritas di unit kerja dalam upaya pencegahan KKN</li>
            </ol>
        </div>
        ...
        <div class="box-content">
            <div>
                ...
                <div class="text-box1">
                    <ol>
                        ...
                        <li>Penetapan SPIP</li>
                        <li>Pengaduan masyarakat</li>
                        <li><span style="font-style: italic;">Wistle-blowing system</span></li>
                        <li>Penanganan benturan kepentingan</li>
                    </ol>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="text-box2">
                    <ol>
                        <li>Mekanisme pengendalian</li>
                        <li>Penanganan pengaduan masyarakat</li>
                        <li>Penyampaian laporan harta kekayaan</li>
                    </ol>
                </div>
            </div>
        </div>
